        ...
        <div class="row">
            <div class="col-lg-4">
                <h2 class="section-title-underline style-2">
                    ...
                    <img src="https://images.unsplash.com/photo-1525921429624-479b6a26d84d?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8MXx8Y29sbGVnZXxlbnwwfHwwfHw%3D&auto=format&fit=crop&w=500&q=60" alt="#" class="w-100 mt-4 rounded" style="opacity: 0.8; box-shadow: rgb(255 255 255 / 10%) 13px 16px 21px 0px;">
                </h2>
            </div>
            <div class="col-lg-8">
...
<div class="news-updates">
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-3">
                <div class="section-heading">
                    <h2 class="text-black">College Videos</h2>
                    <a href="#">View All Videos</a>
                </div>
                <a href="images\v1.mp4" class="video-1 mb-4" data-fancybox="" data-ratio="2">
                    <span class="play">
                        <span class="icon-play"></span>
                    </span>
                    <img src="images\v1.jpg" alt="Image" class="img-fluid">
                </a>
                <a href="images\v2.mp4" class="video-1 mb-4" data-fancybox="" data-ratio="2">
                    <span class="play">
                        <span class="icon-play"></span>
                    </span>
                    <img src="images\v2.jpg" alt="Image" class="img-fluid">
                </a>
            </div>
        </div>
    </div>
